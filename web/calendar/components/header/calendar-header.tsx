        ...
        <div className="flex w-full items-center gap-1.5">
          <div className="inline-flex first:rounded-r-none last:rounded-l-none [&:not(:first-child):not(:last-child)]:rounded-none">
            <Button asChild aria-label="View by day" size="icon" variant={view === "day" ? "default" : "outline"} className="rounded-r-none [&_svg]:size-5">
              <Link href="/admin/events/day-view">
            ...
            >
              <Link href="/admin/events/week-view">
            ...
            <Button
              ...
              className="-ml-px rounded-none [&_svg]:size-5"
            >
              <Link href="/admin/events/month-view">
            ...
            <Button
              ...
              className="-ml-px rounded-none [&_svg]:size-5"
            >
              <Link href="/admin/events/year-view">
            ...
            >
              <Link href="/admin/events/agenda-view">
